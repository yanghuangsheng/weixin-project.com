...
class WxPayConf_pub
{
	...
	const APPID = 'wx7da03a1e72bb4054';
	//受理商ID，身份标识
	const MCHID = '1491739892';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'ghfudencf2uh47fgd8ehrujcfdeytQer';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = 'd6f7cd2e66df2cdd33015caa3ae23f3c';
	...
	const NOTIFY_URL = 'http://ya.56gou.com/demo/notify_url.php';
