...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="http://beginner.zhengjinfan.cn/demo/beginner_admin/">
                    <span style="font-size: 22px;">怡安学车后台</span>
                </a>
            ...
            <ul class="layui-nav admin-header-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="<?php echo U('Login/out');?>"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a>
                        </dd>
                    </dl>
                </li>
            </ul>
    ...
    <script type="text/template" id="lock-temp">
        <div class="admin-header-lock" id="lock-box">
            ...
            <input type="text" class="admin-header-lock-input" value="" name="password" id="lockPwd" />
            <button class="layui-btn layui-btn-small" id="unlock" style="margin-top:-2px;">解锁</button>
        </div>
    </script>
    <!--锁屏模板 end -->
